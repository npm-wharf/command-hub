...
require('yargs') // eslint-disable-line no-unused-expressions
  ...
  .command(require('../src/commands/findAllWorkloads')(client, log))
  .command(require('../src/commands/getCandidates')(client, log))
  .command(require('../src/commands/getAllCandidates')(client, log))
  .command(require('../src/commands/upgradeWorkload')(client, log))
  .command(require('../src/commands/upgradeAllWorkloads')(client, log))
